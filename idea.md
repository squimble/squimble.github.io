...
-also cna filter by whether the target has a telluric
...
ease of use (plug in table and limits, return capable targets (w or w/o telluric), query for data using IRSA (caltech ) or direct 2MASS or WISE query, set limits from gemini or wmkeck or similar observatories)gtk
